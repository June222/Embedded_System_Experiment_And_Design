...
<br>
조이스틱이 DOWN -> LED1, LED2 OFF <br>
조이스틱이 LEFT -> LED3, LED4 OFF <br>
조이스틱이 RIGHT -> LED3, LED4 ON <br>
조이스틱이 UP -> LED1, LED2 ON <br>
...
“Reference Manual.pdf”를 보고 RCC 레지스터에서 APB2 버스에 관련된 clock을 찾는다. <br><br>
...
RCC_APB2ENR 레지스터의 address offset이 0x18 이였기에 <br>
RCC_APB2ENR 레지스터의 주소는 0x40021000 + 0x18 = 0x40021018 이 된다. <br>
...
<img src = "https://github.com/June222/Embedded_System_Experiment_And_Design/blob/main/Docs/3%EC%A3%BC%EC%B0%A8/image/11.png"  width="300"> <br>
...
``` c 
if(!(GPIOC_IDR & UP) )  GPIOD_BSRR |= 0x04;
```

반대로 LED2를 끄려면, GPIOD_BRR에 접근한다.  <br>
``` c 
if(!(GPIOC_IDR & UP) )  GPIOD_BRR |= 0x04;
```
...
```
<img src = "https://github.com/June222/Embedded_System_Experiment_And_Design/blob/main/Docs/3%EC%A3%BC%EC%B0%A8/image/on_1.png"  width="300"> <br>
...
```
<img src = "https://github.com/June222/Embedded_System_Experiment_And_Design/blob/main/Docs/3%EC%A3%BC%EC%B0%A8/image/off.png"  width="300"> <br>
...
```
<img src = "https://github.com/June222/Embedded_System_Experiment_And_Design/blob/main/Docs/3%EC%A3%BC%EC%B0%A8/image/on_2.png"  width="300"> <br>
